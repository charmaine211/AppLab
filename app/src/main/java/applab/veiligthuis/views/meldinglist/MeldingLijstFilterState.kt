...
data class MeldingLijstFilterState(
    val soortGeweldFilter: List<CheckBoxItemState> = listOf(CheckBoxItemState(1, false, "Ongecategoriseerd"), CheckBoxItemState(2, false, "Lichamelijk geweld"), CheckBoxItemState(3, false, "Stalking"), CheckBoxItemState(4, false, "Psychisch geweld"), CheckBoxItemState(5, false, "Financieel misbruik")),
